 ...
 * Privacy Policy Page
 *
 * Displays the privacy policy for ResumeCraft.
 */
      ...
      <div className="container mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          <section>
            ...
            <p>We collect information you provide directly, including your name, email address, and resume content when you use ResumeCraft. We also collect usage data such as pages visited and features used.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>You can access, update, or delete your account and associated data at any time. Contact us at vaishnotiwari12@gmail.com for any privacy-related requests.</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-foreground">6. Contact Us</h2>
            <p>For questions about this privacy policy, contact us at <a href="mailto:vaishnotiwari12@gmail.com" className="text-primary hover:underline">vaishnotiwari12@gmail.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
