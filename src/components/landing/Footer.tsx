    ...
    >
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2.5 mb-4 group">
              ...
              <span className="font-display text-xl font-bold text-foreground">ResumeCraft</span>
            </Link>
            ...
            <div className="flex gap-2">
              {[
                { Icon: Linkedin, href: "https://www.linkedin.com/in/vaishno-prakash-tiwari-989033252/" },
                { Icon: Github, href: "https://github.com/Vaishnotiwari12" },
                { Icon: Twitter, href: "https://x.com/VaishnoSatyam" },
                { Icon: Mail, href: "mailto:vaishnotiwari12@gmail.com" },
              ].map(({ Icon, href }, i) => (
        ...
        <div className="pt-8 border-t border-border/30 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Made with ❤️ by <a href="https://www.linkedin.com/in/vaishno-prakash-tiwari-989033252/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Vaishno Tiwari</a>
          </p>
        </div>
      </div>
    </footer>
